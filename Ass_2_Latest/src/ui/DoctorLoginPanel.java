...
public class DoctorLoginPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        DoctorProfileJPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnBack, btnEdit, btnUpdate});
        ...
        ViewEncounterJPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnBack2, btnEdit1, btnUpdate1});
...
//        }
        ...
        ah.setPerson("Doctor");
        ah.setName(doctorset.getHistory().get(index).getPerson().getName());
...
//        
        txtDOB1.setText(String.valueOf(dr.getPerson().getDOB()));
...
//        System.out.println(saveflag);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        txtDoctorName1.setText(doctorset.getHistory().get(index).getPerson().getName());
